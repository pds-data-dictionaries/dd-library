<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.14.0.0 - Mon Mar 23 15:35:40 PDT 2020 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:information_model_version">
      <sch:assert test=". = ('1.14.0.0')">
        The attribute pds:information_model_version must be equal to the value '1.14.0.0'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Ancillary/pds:Reference_List/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('ancillary_to_data', 'ancillary_to_document')">
        The attribute reference_type must be set to one of the following values 'ancillary_to_data', 'ancillary_to_document'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
