<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:geom  Version:1.3.1.0 - Fri Jul 29 16:40:55 EDT 2016 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="geom:Camera_Model_Parameters/geom:Internal_Reference/pds:reference_type">
      <sch:assert test="pds:local_reference_type = 'geometry_to_camera_model'
            ">
        For geom:Camera_Model_Parameters/geom:Internal_Reference, the reference_type must equal 'geometry_to_camera_model'.
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="//geom:Coordinate_Space_Reference/geom:Local_Internal_Reference">
      <sch:assert test="pds:local_reference_type = 'to_reference_coordinate_space'
            ">
        For all geom:Coordinate_Space_Reference/geom:Local_Internal_Reference, the local_reference_type must equal 'to_reference_coordinate_space'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Central_Body_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_body'
            ">
        For all instances of geom:Central_Body_Identification/geom:Internal_Reference, the reference_type must equal 'geometry_to_body'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Coordinate_System_Origin_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_body'
            ">
        For all instances of geom:Coordinate_System_Origin_Identification/geom:Internal_Reference, the reference_type must equal 'geometry_to_body'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:Expanded_Geometry/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_expanded_geometry'">
        For all instances of geom:Expanded_Geometry/geom:Internal_Reference, the reference_type must equal 'geometry_to_expanded_geometry'
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="geom:Expanded_Geometry/geom:Local_Internal_Reference">
      <sch:assert test="pds:reference_type = 'to_expanded_geometry'">
        For all instances of geom:Expanded_Geometry/geom:Local_Internal_Reference, the reference_type must equal 'to_expanded_geometry'
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Geometry_Target_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_body'">
        For all instances of geom:Geometry_Target_Identification/geom:Internal_Reference, the reference_type must equal 'geometry_to_body'
       </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:Image_Display_Geometry/geom:Local_Internal_Reference">
      <sch:assert test="pds:local_reference_type = 'display_to_data_object'
            ">
        In geom:Image_Display_Geometry/geom:Local_Internal_Reference, the local_reference_type must equal 'display_to_data_object'.
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Observer_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_body'
            ">
        For all instances of geom:Observer_Identification/geom:Internal_Reference, the reference_type must equal 'geometry_to_body'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Reference_Frame_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_reference_frame'
            ">
        For all geom:Reference_Frame_Identification/geom:Internal_Reference, the reference_type must equal 'geometry_to_reference_frame'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Rotate_From/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_reference_frame'
            ">
        For all geom:Rotate_From/geom:Internal_Reference, the reference_type must equal 'geometry_to_reference_frame'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Rotate_To/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_reference_frame'
            ">
        For all geom:Rotate_To/geom:Internal_Reference, the reference_type must equal 'geometry_to_reference_frame'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:Surface_Geometry_Start_Stop">
      ...
      <sch:assert test="ancestor::geom:Geometry_Orbiter/geom:geometry_start_time_utc and ancestor::geom:Geometry_Orbiter/geom:geometry_stop_time_utc">        
      	If you use the Surface_Geometry_Start_Stop class, you must give values for Geometry_Orbiter/geometry_start_time_utc and Geometry_Orbiter/geometry_stop_time_utc.
      </sch:assert>        
  ...
  <sch:pattern>
    <sch:rule context="geom:SPICE_Kernel_Identification/geom:Internal_Reference/pds:reference_type">
      <sch:assert test="pds:local_reference_type = 'geometry_to_SPICE_kernel'
            ">
        For geom:SPICE_Kernel_Identification/geom:Internal_Reference, the reference_type must equal 'geometry_to_SPICE_kernel'
            </sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
