<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:geom  Version:1.3.0.0 - Friday Jul 15 15:06:12 EDT 2016 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:ns uri="http://pds.nasa.gov/pds4/geom/v1" prefix="geom"/>
		   ...
		   <!-- ================================================ -->
  <sch:pattern>
    <sch:rule context="//geom:Coordinate_Space_Reference/geom:Local_Internal_Reference">
      <sch:assert test="pds:local_reference_type = 'to_reference_coordinate_space'">
        For all geom:Coordinate_Space_Reference/geom:Local_Internal_Reference, 
        the local_reference_type must equal 'to_reference_coordinate_space'.
       </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Central_Body_Identification">
      <sch:assert test="if (not(geom:body_spice_name) and not (pds:name) and not (geom:Internal_Reference))  then false() else true()">
        At least one of the following must be present: geom:body_spice_name, pds:name, geom:Internal_Reference.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="//geom:Central_Body_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_body'">
        For all instances of geom:Central_Body_Identification/geom:Internal_Reference, 
        the reference_type must equal 'geometry_to_body'
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Coordinate_System_Origin_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_body'">
        For all instances of geom:Coordinate_System_Origin_Identification/geom:Internal_Reference, the
        reference_type must equal 'geometry_to_body'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:Camera_Model_Parameters/geom:Internal_Reference/pds:reference_type">
      <sch:assert test="pds:reference_type = 'geometry_to_camera_model'">
        For geom:Camera_Model_Parameters/geom:Internal_Reference, the
        reference_type must equal 'geometry_to_camera_model'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:Distances_Start_Stop">
      <sch:assert test="ancestor::geom:Geometry_Orbiter/geom:geometry_start_time and ancestor::geom:Geometry_Orbiter/geom:geometry_stop_time">        
        geom:If you use the Distances_Start_Stop class, you must give values for Geometry_Orbiter/geometry_start_time and Geometry_Orbiter/geometry_stop_time.</sch:assert>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Geometry_Target_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_body'">
        For all instances of geom:Geometry_Target_Identification/geom:Internal_Reference, the
        reference_type must equal 'geometry_to_body'
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:Illumination_Start_Stop">    
      <sch:assert test="ancestor::geom:Geometry_Orbiter/geom:geometry_start_time and ancestor::geom:Geometry_Orbiter/geom:geometry_stop_time">        
        geom:If you use the Illumination_Start_Stop class, you must give values for Geometry_Orbiter/geometry_start_time and Geometry_Orbiter/geometry_stop_time.</sch:assert>
  ...
  <sch:pattern>
    <sch:rule context="geom:Illumination_Specific">
  ...
  <sch:pattern>
    <sch:rule context="geom:Illumination_Specific/geom:reference_location">
      <sch:assert test=". = ('Boresight Intercept Point', 'Subspacecraft Point', 'Target Center')">
        Within the geom:Illumination_Specific class, the attribute geom:reference_location is restricted to one of the following values 'Boresight Intercept Point', 'Subspacecraft Point', 'Target Center'. In this class the value 'Constant' is not used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Observer_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_observer'">
        For all instances of geom:Observer_Identification/geom:Internal_Reference, the
        reference_type must equal 'geometry_to_observer'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Reference_Frame_Identification">
      <sch:assert test="if (not(geom:frame_spice_name) and not (pds:name) and not (geom:Internal_Reference))  then false() else true()">
        At least one of the following must be present: geom:frame_spice_name, pds:name, geom:Internal_Reference.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="//geom:Reference_Frame_Identification/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_reference_frame'">
        For all geom:Reference_Frame_Identification/geom:Internal_Reference, the
        reference_type must equal 'geometry_to_reference_frame'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Rotate_From/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_reference_frame'">
        For all geom:Rotate_From/geom:Internal_Reference, the
         reference_type must equal 'geometry_to_reference_frame'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="//geom:Rotate_To/geom:Internal_Reference">
      <sch:assert test="pds:reference_type = 'geometry_to_reference_frame'">
        For all geom:Rotate_To/geom:Internal_Reference, the
        reference_type must equal 'geometry_to_reference_frame'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:SPICE_Kernel_Identification/geom:Internal_Reference/pds:reference_type">
      <sch:assert test="pds:reference_type = 'geometry_to_SPICE_kernel'">
        For geom:SPICE_Kernel_Identification/geom:Internal_Reference, the
        reference_type must equal 'geometry_to_SPICE_kernel'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="geom:Image_Display_Geometry/geom:Local_Internal_Reference">
      <sch:assert test="pds:local_reference_type = 'display_to_data_object'">
        In geom:Image_Display_Geometry/geom:Local_Internal_Reference, the
        local_reference_type must equal 'display_to_data_object'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="geom:Geometry_Orbiter">
      <sch:assert test="if ((geom:geometry_start_time) and not (geom:geometry_stop_time))  then false() else true()">
        geom:geometry_start_time and geom:geometry_stop_time, are a pair; if you use one, you must use both.</sch:assert>
      <sch:assert test="if ((geom:geometry_stop_time) and not (geom:geometry_start_time))  then false() else true()">
        geom:geometry_start_time and geom:geometry_stop_time, are a pair; if you use one, you must use both.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="geom:Surface_Geometry_Start_Stop">
      ...
      <sch:assert test="ancestor::geom:Geometry_Orbiter/geom:geometry_start_time and ancestor::geom:Geometry_Orbiter/geom:geometry_stop_time">        
      	If you use the Surface_Geometry_Start_Stop class, you must give values for Geometry_Orbiter/geometry_start_time and Geometry_Orbiter/geometry_stop_time.
      </sch:assert>
