...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="cart:Geodetic_Model/cart:spheroid_name">
      <sch:assert test=". = ('Carke 1866', 'Geodetic Reference System 80')">
        The attribute cart:spheroid_name must be equal to one of the following values 'Carke 1866', 'Geodetic Reference System 80'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
