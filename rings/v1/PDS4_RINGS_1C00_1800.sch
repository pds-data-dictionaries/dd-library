<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:rings  Version:1.8.0.0 - Thu Feb 06 15:16:52 EST 2020 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="//Ring_Reprojection/rings:Reprojection_Geometry">
      <sch:assert test="if ((rings:corotating_flag='Y') and not (rings:corotation_rate))  then false() else true()">
        You must supply the corotation rate, rings:corotation_rate, associated with the co-rotation frame. </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="rings:Occultation_Ring_Profile/rings:ring_plane">
      <sch:assert test=". = ('A', 'Alpha', 'B', 'Beta', 'C', 'D', 'Delta', 'E', 'Epsilon', 'Equator', 'Eta', 'F', 'Five', 'Four', 'G', 'Gamma', 'Individual', 'Lambda', 'Mu', 'Nu', 'Phoebe', 'Six')">
        The attribute rings:ring_plane must be equal to one of the following values 'A', 'Alpha', 'B', 'Beta', 'C', 'D', 'Delta', 'E', 'Epsilon', 'Equator', 'Eta', 'F', 'Five', 'Four', 'G', 'Gamma', 'Individual', 'Lambda', 'Mu', 'Nu', 'Phoebe', 'Six'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="rings:Reprojection_Geometry/rings:reprojection_plane">
      <sch:assert test=". = ('A', 'Alpha', 'B', 'Beta', 'C', 'D', 'Delta', 'E', 'Epsilon', 'Equator', 'Eta', 'F', 'Five', 'Four', 'G', 'Gamma', 'Lambda', 'Laplace', 'Mu', 'Nu', 'Phoebe', 'Six')">
        The attribute rings:reprojection_plane must be equal to one of the following values 'A', 'Alpha', 'B', 'Beta', 'C', 'D', 'Delta', 'E', 'Epsilon', 'Equator', 'Eta', 'F', 'Five', 'Four', 'G', 'Gamma', 'Lambda', 'Laplace', 'Mu', 'Nu', 'Phoebe', 'Six'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
